...
metric_cols[3].metric("Total de despesas", format_brl(stats["expense_total"]))
...
total_cols[2].metric("Total hotel", format_brl(totals["hotel_total"]))
total_cols = st.columns(3)
total_cols[0].metric("Total geral", format_brl(totals["expense_total"]))
total_cols[1].metric("Adiantamento", format_brl(totals["advance_total"]))
total_cols[2].metric("Saldo", format_brl(totals["balance"]))
